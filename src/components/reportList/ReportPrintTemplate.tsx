...
export default function ReportPrintTemplate({ page, reportUser }: { page: number, reportUser: ReportUser | null }) {
    return page === 1 ? <Page1 reportUser={reportUser} /> : <Page2 />;
}

type Props = {
    reportUser: ReportUser | null,
}
function Page1({ reportUser }: Props) {
            ...
            <div id="printOne" className={'flex flex-col gap-8 bg-white aspect-[1/1.414] h-full p-10 text-[.65rem] font-medium select-none'}>
                ...
                <div className={'flex flex-col border border-black'}>
                    <div className={'flex items-end justify-end p-1 pb-5 border-b border-black'}>
                        ...
                        <div className={'w-40 border-b border-black px-2'}>{fechaFormateada}</div>
                    </div>
                    <div className={'flex flex-col border-black divide-y'}>
                        ...
                        <div className={'flex justify-between border-black'}>
                            ...
                            <div className={'flex justify-center items-center'}>
                                ...
                                <div className={'w-24 px-2'}>{reportUser?.age}</div>
                            </div>
                        </div>
                        <div className={'flex justify-between border-black'}>
                            <div className={''}>
                            ...
                            <div className={'flex justify-center items-center'}>
                                ...
                                <div className={'w-24'}>{reportUser?.phone}</div>
                            </div>
                        </div>
                        ...
                        <div className={'flex border-black'}>
                            ...
                            <div className={'flex divide-x border-r border-black'}>
                                ...
                                <span className={'grid place-content-center font-bold w-10 border-black'}>{reportUser?.traffic_accident ? 'X' : ''}</span>
                    ...
                    <div className={'flex flex-col'}>
                        ...
                        <div className={'p-1 h-32'}>
                            ...
                            5. una galería de textos y los mezcló de tal manera que logró hacer un libro de textos especimen.
                        </div>
                    </div>
                    <div className={'flex flex-col'}>
